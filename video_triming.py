...
from path import meta_data_csv, base_enrichie, segment_video_csv, video_path, ffmpeg_path
        ...
        for dir in os.listdir(base_enrichie):
            if dir == hashcode:
                ...
                if(time_start_hour == 23 and time_end_hour ==0):
                    ...
                    output_filename = create_date_from_start(timestamp) + "_video.mp4"
                    ...
                    df.to_csv(segment_video_csv, index = False, header=True, encoding="utf-8-sig")
